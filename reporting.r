...
# 3.0 SAVE FUNCTIONS ----
# 3.1 Create a file
fs::file_create("C:/Users/rueta/Desktop/Data-Science-Products/plot_sales.R")

# 3.2 Save funtions to the file
dump(list = c("plot_total_sales", "plot_categories", "format_to_euro", "euro_format"), file = "C:/Users/rueta/Desktop/Data-Science-Products/plot_sales.R")
